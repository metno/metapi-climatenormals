...
@ApiModel(description="Data response for climate normals day elements")
case class ClimateNormalsDayElementsResponse(
  ...
  @(ApiModelProperty @field)(
    name=ApiConstants.OBJECT_TYPE_NAME, value=ApiConstants.OBJECT_TYPE, example="ClimateNormalsDayElementsResponse") responseType: String,
  ...
  @(ApiModelProperty @field)(value=ApiConstants.DATA) data: Seq[ClimateNormalsDayElement]
)
...
@ApiModel(description="Metadata for a single climate normals day element")
case class ClimateNormalsDayElement(
    @(ApiModelProperty @field)(value="Element id.", example="TAM") elementId: String
)
