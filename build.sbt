...
description := "Climate normals module of the metapi. <more documentation to come>"
...
// Play settings
// ----------------------------------------------------------------------
PlayKeys.devSettings += ("play.http.router", "climatenormals.Routes")
...
coverageExcludedPackages := """
  ...
  ReverseApplication;
  ReverseAssets;
  climatenormals.Routes;
  climatenormals.RoutesPrefix;
"""
